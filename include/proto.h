...
/*
 * This file was automatically generated by version 1.7 of cextract. Manual
...
extern AlarmEvent *
setAlarmEvent(AlarmEvent * event, int sec, short status,
	      int cmd, void *data);
#else
...
extern void 
flushline(struct html_feed_environ * h_env, struct readbuffer * obuf,
	  int indent, int force, int width);
extern void 
do_blankline(struct html_feed_environ * h_env,
	     struct readbuffer * obuf, int indent, int indent_incr,
	     int width);
extern void purgeline(struct html_feed_environ * h_env);
extern void 
save_fonteffect(struct html_feed_environ * h_env,
		struct readbuffer * obuf);
extern void 
restore_fonteffect(struct html_feed_environ * h_env,
		   struct readbuffer * obuf);
#ifdef USE_IMAGE
...
extern int 
HTMLtagproc1(struct parsed_tag * tag,
	     struct html_feed_environ * h_env);
extern void HTMLlineproc2(Buffer * buf, TextLineList * tl);
extern void 
HTMLlineproc0(char *istr, struct html_feed_environ * h_env,
	      int internal);
#define HTMLlineproc1(x,y) HTMLlineproc0(x,y,TRUE)
extern Buffer *loadHTMLBuffer(URLFile * f, Buffer * newBuf);
extern char *convert_size(off_t size, int usefloat);
extern char *convert_size2(off_t size1, off_t size2, int usefloat);
extern void showProgress(off_t *linelen, off_t *trbyte);
extern void 
init_henv(struct html_feed_environ *, struct readbuffer *,
	  struct environment *, int, TextLineList *, int, int);
extern void 
completeHTMLstream(struct html_feed_environ *,
		   struct readbuffer *);
extern void 
...
extern void 
addDownloadList(pid_t pid, char *url, char *save, char *lock,
		off_t size);
...
extern Buffer *
selectBuffer(Buffer * firstbuf, Buffer * currentbuf,
	     char *selectchar);
...
extern int 
calcPosition(char *l, Lineprop * pr, int len, int pos, int bpos,
	     int mode);
...
extern char *
inputLineHistSearch(char *prompt, char *def_str, int flag,
