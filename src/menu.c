...
static wc_ces MainMenuCharset = WC_CES_US_ASCII;	/* FIXME: charset of
							 * source code */
...
static MenuItem MainMenuItem[] = {
	/*
	 * type        label           variable value func     popup keys
	 * data
	 */
...
DEFUN(mainMn, MAIN_MENU MENU, "Popup menu")
{
	...
	char *data;
	int n;
	int x = Currentbuf->cursorX + Currentbuf->rootX, y = Currentbuf->cursorY + Currentbuf->rootY;
