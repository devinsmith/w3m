...
#ifdef USE_M17N
static wc_ces OptionCharset = WC_CES_US_ASCII;	/* FIXME: charset of source
						 * code */
...
struct param_ptr params1[] = {
	...
	/*
	 * XXX: emacs-w3m force to off display_image even if image options
	 * off
	 */
...
sync_with_option(void)
{
	...
	if (AcceptLang == NULL || *AcceptLang == '\0') {
		/*
		 * TRANSLATORS: AcceptLang default: this is used in
		 * Accept-Language: HTTP request header. For example, ja.po
		 * should translate it as "ja;q=1.0, en;q=0.5" like that.
		 */
